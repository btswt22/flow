...
class GenData(object):
	...
	def gen_random_data(self):
		...
		hourly_counter,sensor=1 counter=1 1434067467000000000
		"""
		output_data = []
		current_time = self._date
		# direction = ['l', 'r'] # Record direction if using two sensors
		...
		for i in range(1000):
			...
			entry_text = "hourly_counter,sensor=%s counter=1 %s" % (
				self._sensor_id,
				# entry_direction,
