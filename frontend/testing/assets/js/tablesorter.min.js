! function($) {
        ...
        tablesorter: new function() {
            ...
            function buildParserCache(e, t) {
                ...
                if (0 != e.tBodies.length) {
                    ...
                    if (n[0])
                        for (var o = [], a = n[0].cells, i = a.length, s = 0; i > s; s++) {
                            var d = !1;
            ...
            function detectParserForColumn(e, t, r, n) {
                for (var o = parsers.length, a = !1, i = !1, s = !0;
                    "" == i && s;) r++, t[r] ? (a = getNodeFromRowAndCellIndex(t, r, n), i = trimAndGetNodeText(e.config, a), e.config.debug && log("Checking if value was empty on row:" + r)) : s = !1;
                for (var d = 1; o > d; d++)
                    if (parsers[d].is(i, e, a)) return parsers[d];
                return parsers[0]
            }
            ...
            function getParserById(e) {
                for (var t = parsers.length, r = 0; t > r; r++)
            ...
            function buildCache(e) {
                ...
                for (var r = e.tBodies[0] && e.tBodies[0].rows.length || 0, n = e.tBodies[0].rows[0] && e.tBodies[0].rows[0].cells.length || 0, o = e.config.parsers, a = {
                    ...
                    var s = $(e.tBodies[0].rows[i]),
                        d = [];
                    if (s.hasClass(e.config.cssChildRow)) a.row[a.row.length - 1] = a.row[a.row.length - 1].add(s);
                    else {
                        a.row.push(s);
                        for (var c = 0; n > c; ++c) d.push(o[c].format(getElementText(e.config, s[0].cells[c]), e, s[0].cells[c]));
            ...
            function appendToTable(e, t) {
                ...
                for (var n = t, o = n.row, a = n.normalized, i = a.length, s = a[0].length - 1, d = $(e.tBodies[0]), c = [], u = 0; i > u; u++) {
                    var l = a[u][s];
                    if (c.push(o[l]), !e.config.appender)
                        for (var f = o[l].length, h = 0; f > h; h++) d[0].appendChild(o[l][h])
                }
                ...
                for (var t = [], r = {}, n = e.getElementsByTagName("THEAD")[0], o = n.getElementsByTagName("TR"), a = 0; a < o.length; a++)
                    for (var i = o[a].cells, s = 0; s < i.length; s++) {
                        ...
                        for (var g = u; u + f > g; g++) {
                            ...
                            for (var m = t[g], p = d; d + h > p; p++) m[p] = "x"
                        }
                    }
                return r
            }
            ...
            function getWidgetById(e) {
                for (var t = widgets.length, r = 0; t > r; r++)
            ...
            function setHeadersCss(e, t, r, n) {
                ...
                for (var a = r.length, i = 0; a > i; i++) o[r[i][0]].addClass(n[r[i][1]])
            }
            ...
            function updateHeaderSortCount(e, t) {
                for (var r = e.config, n = t.length, o = 0; n > o; o++) {
                    var a = t[o],
                        i = r.headerList[a[0]];
                    i.count = a[1], i.count++
                }
                                ...
                                if (this.order = this.count++ % 2, this.lockedOrder && (this.order = this.lockedOrder), e[o.sortMultiSortKey])
                                    if (isValueInArray(s, o.sortList))
                                        ...
                                        if (o.sortList = [], null != o.sortForce)
                                            for (var l = o.sortForce, d = 0; d < l.length; d++) l[d][0] != s && o.sortList.push(l[d]);
    ...
    ts.addParser({
        ...
        format: function(e) {
            for (var t = e.split("."), r = "", n = t.length, o = 0; n > o; o++) {
                var a = t[o];
                r += 2 == a.length ? "0" + a : a
            }
